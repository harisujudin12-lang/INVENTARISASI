...
const menuItems = [
  ...
  { href: '/admin/requests', label: 'Request', icon: 'request' },
  { href: '/admin/inventory', label: 'Inventory', icon: 'inventory' },
  { href: '/admin/divisions', label: 'Divisi', icon: 'division' },
  { href: '/admin/form-builder', label: 'Form Builder', icon: 'form' },
...
export default function AdminLayout({ children }: { children: React.ReactNode }) {
  ...
  async function checkAuth() {
    try {
      ...
      console.log('[Layout] Auth response:', res.status)
      const json = await res.json()
      if (json.success) {
        console.log('[Layout] Auth OK - user:', json.data.username)
        setAdmin(json.data)
      } else {
